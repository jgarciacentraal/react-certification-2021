...
const mockVideos = [
  ...
  },
  {
    ...
    description:
      'Wizeline continues to offer a Silicon Valley culture in burgeoning innovation hubs like Mexico and Vietnam.',
...
describe('Testing useIsFavorite hooks', () => {
  ...
  it('Finding a favorite video', async () => {
    const { result } = renderHook(() => useIsFavorite('nmXMgqjQzls', mockVideos, user));
